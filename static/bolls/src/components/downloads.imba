...
export tag Downloads
  ...
  def build
    ...
    if window:navigator:platform.slice(0, 5) == "Linux"
      ...
      @link = "https://storage.googleapis.com/bolls-256717.appspot.com/bolls-0.1.0.dmg"
    elif window:navigator:platform.slice(0, 3) == "Win"
      @link = "https://storage.googleapis.com/bolls-256717.appspot.com/Bolls Setup 0.1.0.exe"
    console.log @link
  ...
  def render
    <self>
      ...
      <#downloads-container>
        <a.platform-item href="https://storage.googleapis.com/bolls-256717.appspot.com/bolls-0.1.0.dmg">
        ...
        <a.platform-item href="https://storage.googleapis.com/bolls-256717.appspot.com/Bolls Setup 0.1.0.exe">
        ...
        <a.platform-item href="https://storage.googleapis.com/bolls-256717.appspot.com/bolls-0.1.1.AppImage">
