export const en_leng = {
  ...
  wanna_help: "If you lack some translation or want to bring interface of this app to your native language I will be glad to collaborate with you. Write to me here => ",
...
export const uk_leng = {
  ...
  wanna_help: "Якщо вам не вистачає якогось перекладу або ви хочете перекласти інтерфейс цього додатка на вашу рідну мову, то я буду радий співпрацювати з вами. Напишіть мені тут => ",
...
export const ru_leng = {
  ...
  wanna_help: "Если вам не хватает какогото перевода или вы хотите перевести интерфейс этого приложения на свой родной язык, то я буду рад сотрудничать с вами. Напишите мне здесь =>",
