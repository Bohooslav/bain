...
export tag Bible
  ...
  def getParallelText translation, book, chapter, caller, verse
  ...
  def backInHistory h, parallel
    if parallel != undefined
      getParallelText(h:translation, h:book, h:chapter, no, h:verse)
    else
      ...
      <aside.settings-menu css:transform="translateX({settings_menu_left}px)">
        ...
        <footer>
          <address css:padding-bottom="4px">
            <a href="/api"> "© "
              <time time:datetime="2020-01-11T21:00"> "2019-2020"
              ...
              for verse, key in getFilteredArray
                <a.search_item>
                  ...
                  <.search_res_verse_header>
                    ...
                    <span> verse:chapter, ':'
                    <span> verse:verse
                    <svg:svg.open_in_parallel style="padding: 8px 4px 0; margin-left: 4px; transform: translateY(2px);" viewBox="0 0 400 338" :tap.prevent.backInHistory({translation: @search:translation, book: verse:book, chapter: verse:chapter,verse: verse:verse}, yes)>
