...
export tag Bible
  ...
  def getParallelText translation, book, chapter
    ...
    if window:username
      ...
      @parallel_bookmarks = []
      @parallel_bookmarks = (await load url):data
  ...
  def getParallelHighlight verse
    console.log @parallel_bookmarks
    if choosenid:length && choosenid.find(do |element| return element == verse)
      return highlight_color
    else
    ...
    <self .noscroll=search:search_div>
      <nav.bible-menu css:transform="translateX({ bible_menu_left }px)">
        ...
        <ul.translations_list .show_list_of_chapters=@show_list_of_translations>
          for translation in translations
            <li.book_in_list css:font-size="18px" :tap.prevent.changeTranslation(translation:short_name)> translation:full_name
        if parallel_text:edited_version == parallel_text:translation && parallel_text:display
          for book in @parallel_books
            ...
            <ul.list_of_chapters .show_list_of_chapters=(book:bookid==show_chapters_of)>
              for i in Array.from(Array(book:chapters).keys())
                <li.chapter_number :tap.prevent.getParallelText(parallel_text:translation, book:bookid, i+1)> i+1
        else
          for book in @books
            <div.book_in_list :tap.prevent.showChapters(book:bookid)> book:name
            <ul.list_of_chapters .show_list_of_chapters=(book:bookid==show_chapters_of)>
              for i in Array.from(Array(book:chapters).keys())
                <li.chapter_number :tap.prevent.getText(settings:translation, book:bookid, i+1)> i+1
        <div.freespace>
        ...
        <section .first_parallel=parallel_text:display .right_align=(settings:translation=="WLC")>
          ...
          for verse in @verses
            <span.verse id=verse:fields:verse>
              ...
              verse:fields:verse
            <span
              :tap.prevent.addToChoosen(verse:pk, verse:fields:verse, false)
        ...
        <section.second_parallel .show_parallel=parallel_text:display .right_align=(parallel_text:translation=="WLC")>
          ...
          for verse in @parallel_verses
            <span.verse>
              ...
              verse:fields:verse
            <span
              :tap.prevent.addToChoosen(verse:pk, verse:fields:verse, true)
      ...
      <aside.settings-menu css:transform="translateX({settings_menu_left}px)">
        ...
        <div.nighttheme .theme_checkbox_light=parallel_text:display>
          langdata:parallel
          <div.parallel_checkbox :tap.prevent.toggleParallelMode>
        ...
        <div.profile_in_settings>
          if user:name
            <a.username href='/profile' :tap.prevent.Prof> user:name
      ...
      <section.search_results .show_search_results=search:search_div>
        <div.search_hat>
          <svg:svg.close_search :tap.prevent=(do search:search_div = false) xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <div.hide .choosen_verses=choosenid:length>
        <div.markingcontainer>
          <div.forinput .show_note_input=show_note_input>
            <p> langdata:add_note
            <textarea[store:note].note-input :keydown.enter.prevent=(do show_note_input = !show_note_input)>
          ...
          <div.addbuttons>
            <svg:svg.close_search :tap.prevent.closeMark xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" css:margin="auto">
            ...
            <svg:svg.close_search :tap.prevent.deleteBookmarks xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" css:margin="auto">
              <svg:title> langdata:delete
              <svg:path d="M6 2l2-2h4l2 2h4v2H2V2h4zM3 6h14l-1 14H4L3 6zm5 2v10h1V8H8zm3 0v10h1V8h-1z">

            <svg:svg.save_bookmark :tap.prevent.copyToClipboard xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <svg:svg.save_bookmark .filled=store:note :tap.prevent=(do show_note_input = !show_note_input) xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <svg:svg.save_bookmark xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" :tap.prevent.sendBookmarksToDjango>
